...
class ProgramsRepository {
  ...
  Future<Exercise> addExercise(String sessionId, Map<String, dynamic> data) async {
    final res = await _api.dio.post('/api/v1/sessions/$sessionId/exercises', data: data);
  ...
  Future<void> assignClients(String programId, List<String> clientIds) async {
    await _api.dio.post('/api/v1/programs/$programId/assign', data: {'client_ids': clientIds});
  }
}
