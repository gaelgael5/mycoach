                ...
                data: (clients) => Padding(
                  ...
                  child: Chip(
                    label: Text(
                      ...
                      style: TextStyle(
                        color: clients.length >= AppConfig.maxFreeClients ? AppColors.error : AppColors.secondary,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
                    backgroundColor: (clients.length >= AppConfig.maxFreeClients ? AppColors.error : AppColors.secondary).withValues(alpha: 0.1),
                  ),
                ),
              ) ??
        ...
        child: clientsAsync.when(
          ...
          error: (e, _) => Center(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('Erreur: $e'),
              const SizedBox(height: 12),
              ElevatedButton(onPressed: () => ref.invalidate(clientsListProvider), child: const Text('Réessayer')),
            ]),
          ),
