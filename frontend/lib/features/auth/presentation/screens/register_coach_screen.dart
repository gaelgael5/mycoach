...
/// Écran d'inscription pour un coach.
/// Flow : RegisterCoachScreen → POST register (phone obligatoire)
///        → OtpSmsScreen → EmailVerificationScreen → CoachHome
class RegisterCoachScreen extends ConsumerStatefulWidget {
  const RegisterCoachScreen({super.key});

  @override
  ConsumerState<RegisterCoachScreen> createState() =>
      _RegisterCoachScreenState();
}

class _RegisterCoachScreenState extends ConsumerState<RegisterCoachScreen> {
  ...
  String _localizeError(Object e) {
    ...
    return switch (code) {
      ...
      ApiErrorCode.phoneAlreadyExists => l10n.registerPhoneAlreadyExists,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          context.l10n.registerCoachTitle,
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    context.l10n.registerPhoneMandatoryInfo,
